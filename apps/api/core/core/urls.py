...
from s3.views import S3PresignedUrl, BlurHash, RemoveCoverImageAPIView
urlpatterns = [
    ...
    path('api/s3/remove-cover-image/', RemoveCoverImageAPIView.as_view(), name='remove-cover-image'),
]
